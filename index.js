            ...
            document.getElementById('temp1').addEventListener('click',function(){
                let theme= document.getElementById('firstpage')
                theme.classList.add('dispnone')
                let invsible=document.getElementById('invsible')
invsible.innerHTML=`<div class="contaner" id="pdf-resum">
        
        <div class="personalifo">
           
                <img class="yellow" src="/img/ttt.png" alt="this image">
            
            <div class="img">
                  <img class="profile" src="/img/marble.jpg" alt=""><input type="file"id="file-upload"><label class="label" for="file-upload" class="custom-file-upload">
                  <img class="profile-edit" src="img/photo-camera.png" alt="">
                  </label>
            ...
            <div class="contect"><h1 id="contect " class="prsnonalheading textwhit" >CONTACT</h1><img class="logosize" src="img/userwhite.png" alt=""></div><hr class="textwhit opacity">

            <div class="phon flex"><img class="logosize logobg" src="img/phon.png" alt=""><p id="phont" class="textwhit" >+3122313716</p></div>
            <div class="phon flex"><img class="logosize logobg" src="img/mail.png" alt=""><p id="mailt" class="textwhit mail"  >samiullahmalik7474@gmial.com</p></div>
             <div class="coco"><div class="phon flex"><img class="logosize logobg cocoimg" src="img/location.png" alt=""><p id="adresst" class="cocop textwhit" >Your address</p></div>
</div>
           <div id="web" class="coco"> <div class="phon flex"><img class="logosize logobg cocoimg" src="img/website.png" alt=""><p id="websitet" class="cocop textwhit" >www.come.com</p></div></div>

            </div>


            <div id="ed" class="education">
               
            </div>
            <div class="skill-container">
            <div class="skill-head">
                <div class="skillheading ed-head "><h1 class="textwhit" >SKILLS</h1></div>
                <div class="skill-logo"><img class="logosize" src="img/skills.png" alt=""></div>
            </div>
            <hr class="textwhit opacity">
            <div id="resume-skills" class="skill-body">
        ...
        <div class="profassion">
            <div class="fix">
            <div class="nameinfo"><div class="name"><h1 id="namet" >SAMIULLAH MALIK</h1><p id="t" >FULL STACK WEB DEVELOPER</p></div></div>



            <div class="profasional-profile"><div class="profasional-heading"><h1 >PROFESSIONAL PROFILE</h1><img class="logosize" src="img/userblack.png" alt=""></div><hr> <p id="profassionalprofilet" >Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae minus dignissimos accusamus deserunt praesentium aut soluta dolorem laborum nostrum dicta repellendus inventore blanditiis, dolore aliquid, necessitatibus aliquam sequi labore quis!Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae minus dignissimos accusamus deserunt praesentium aut soluta dolorem laborum nostrum dicta repellendus inventore blanditiis, dolore aliquid, necessitatibus aliquam sequi labore quis!</p></div>


            <div class="work-experience">
            <div class="profasional-heading"><h1  >WORK EXPERIENCE</h1><img class="logosize" src="img/work.png" alt=""></div><hr>
                <div id="excontainer">
...
boxfm.innerHTML=`  <div class="boxfm">
        ...
        <div class="containerfm">
                <div class="leftfm">
                        ...
                        <!-- <div class="contectfm"> -->
                           ...
                           <div class="inputcontrol">
                            ...
                            <input type="text" maxlength="100" id="websitefm" placeholder="Opsional" ><div class="error"></div>
                          ...
                          <img id="man" class="man" src="img/man.jpg" alt="">
                            ...
                            <div class="inputcontrol">
                            <label class="label" for="year1fb"></label><br>
                            ...
                            <input type="text" maxlength="20" id="degree1fm" ><div class="error"></div></div>

                            <div class="inputcontrol">
                            <label class="label" for="degrerdetail1fm">Universtiy/College/Institute</label><br>
                            <input type="text" maxlength="20" id="degrerdetail1fm" ><div class="error"></div></div>
                    ...
                    <button type="button" class="next" id="update-ed-btn">Next</button></div>
                        ...
                        <!-- <div class="skillsfm"> -->
                            ...
                            <div class="inputcontrol">
                            <input type="text" maxlength="12" id="skil1fm" ><div class="error"></div></div>

                            <div class="inputcontrol">
                            <label class="label" for="inputbar">Expert level % --</label>
                            <input id="inputbar" class="inputbar" ><div class="error"></div></div>
                        </div>
                        </div>
                        </div>
                ...
                <div class="rightfm">
                    ...
                    <label class="prlable" for="file-upload" class="custom-file-upload flex"> 
                    <p class="profilep">upload Image</p>
                        </label>
                            ...
                            <input type="text" maxlength="20" id="namefm" ><div class="error"></div></div>

                            <div class="inputcontrol">
                            <label class="label" for="profassionfm">Type your profassion</label><br>
                            <input type="text" maxlength="20" id="profassionfm" ><div class="error"></div></div>
                            ...
                            <textarea name="profassion-profilefb" maxlength="250" id="profassion-profilefb"  rows="5"></textarea><div class="error"></div></div>
                             <div class="btndiv"><button type="button" id="contback1" class="back">Back</button>
                            ...
                            <div class="inputcontrol">
                            <label class="label" for="workexperiecefm1">Type your profassion</label>
...
btn2.addEventListener("click", () => {
  ...
  var element = document.getElementById('pdf-resum'); // The element to convert to PDF
...
function contectsucess(){
    ...
    function skillsucess(){
        ...
        // document.getElementById("skil1").innerText = skill1.value.trim().charAt(0).toUpperCase() + skill1.value.slice(1);
        document.getElementById('skillnav').classList.remove('sec1')
        document.getElementById('cvnav').classList.add('sec1')
        nextpage()
...
document.getElementById('profassionbtn').addEventListener('click', function(){
    ...
    function profassionsucess(){
        ...
        success(name1)    
        document.getElementById("namet").innerText = name1.value.toUpperCase();
    con1=true}
        if(profassion.value==""){
        ...
        success(profassion)
            document.getElementById("t").innerText = profassion.value.toUpperCase();
        con2=true}
    ...
    function workexpsucess(){
            ...
            document.getElementById('invsible').classList.remove('invsible')
            document.getElementById('cvnav').classList.remove('sec1')
    ...
    document.getElementById('add-skill-btn').addEventListener('click', function() {
        ...
        <label class="label" for="skil1fm">Skill ${skillcount+2}</label><br>
            <div class="inputcontrol">
                <input type="text" maxlength="12" name="skills[]" id="skills"  required>
                <div class="error"></div>
            </div>
            <div class="inputcontrol">
                <label class="label" for="inputbar">Expert level % --</label>
                <input class="inputbar" name="expert-level[]"  required>
                <div class="error"></div>
            </div>
    ...
    document.getElementById('update-resume-btn').addEventListener('click', function() {
        ...
        let skilval= skill1.value
 resumeSkills.innerHTML=`<div class="skill-row"><div id="skil1" class="skilname textwhit" >${skilval}</div><div class="skill-bar"></div></div>
`
        document.getElementById('skillnav').classList.remove('sec1')
        document.getElementById('cvnav').classList.add('sec1')
        ...
        if(skill1.value==""){
            ...
            let skilval= skill1.value.trim().charAt(0).toUpperCase() + skill1.value.slice(1);
            resumeSkills.innerHTML=`<div class="skill-row"><div id="skil1" class="skilname textwhit" >${skilval}</div><div class="skill-bar"></div></div>
           `
                   let bar=document.querySelector('.skill-bar');
                   let inputbar=document.getElementById('inputbar');
        ...
        skills.forEach((skillInput, index) => {
            ...
            let level = levels[index].value.trim();
            ...
            if(!skill){
                ...
                skillName.classList.add('skilname', 'textwhit');
                ...
                skillBar.style.width = `${level}px`; // Set width based on expert level
    
                // Append skill name and skill bar to the row
                skillRow.appendChild(skillName);
                skillRow.appendChild(skillBar);
...
document.getElementById('update-ed-btn').addEventListener('click', function() {
    let body_ed=document.getElementById('ed');
    body_ed.innerHTML=``;
    if(ed ===0){  
        let con1=false
        let con2=false
...
let yearrr="";
    ...
    con4=true}
        ...
        if(con1 &&
            ...
            con3 &&
        con4){
            let yearrr=year1.value;
            let body_ed=document.getElementById('ed');
            body_ed.innerHTML=` <div class="ed-head"><h1 class="textwhit" >EDUCATION</h1><img class="logosize" src="img/education.png" alt=""></div>
                <hr class="textwhit opacity">
    ...
    // Clear the previous education rows in the resume section
    let edcontainerResume = document.getElementById('ed');  // Make sure this container exists
    // edcontainerResume.innerHTML = '';  // Clear current content
    let con1=false
    let con2=false
    let con3=false
    let con4=false
...
let allvalid=true;
    ...
    years.forEach((yearInput, index) => {
        ...
        eddegree.classList.add('degree', 'textwhit');
        eddegree.textContent = degree;

        let eddetail = document.createElement('div');
        eddetail.classList.add('detail', 'textwhit', 'italic');
        eddetail.textContent = detail;

        let gpa1 = document.createElement('div');
        gpa1.classList.add('detail', 'textwhit');
        gpa1.textContent = gpa;

        let body = document.createElement('div');
        body.classList.add('year-body');

        let edbody= document.createElement('div')
            edbody.classList.add('ed-body')

            let hrsub=document.createElement('hr')
            hrsub.classList.add('year-hr')
        ...
        if(!year){seterror(yearInput,"please fill the inputs")
            ...
            success(yearInput)
            edbody.appendChild(edyear);
            edbody.appendChild(hrsub)}
            ...
            if(!degree){seterror(degrees[index],"please fill the inputs") 
                ...
                if(!detail){seterror(details[index],"please fill the inputs")
                    ...
                    if(!gpa){seterror(gpas[index],"please fill the inputs")
                        ...
                        let hrmain=document.createElement('hr')
                        hrmain.classList.add('textwhit', 'opacity')
             
             
                        edcontainerResume.appendChild(edbody)
                        edcontainerResume.appendChild(hrmain)}
...
let work = 1;
let maxwork = 3;  // Max education items allowed
...
con5=true}
    ...
    if(con1 &&
        ...
        con6 ){
           ...
           excontainer.innerHTML=` <div class="ex-body">
                <div id="startyear1t" class="yeartow" >${yearstart1.value}</div><div id="endyear1t"  class="yeartow" >${yearend1.value}</div><hr class="year-hr2">
                <div  class="year-bodytow"><div id="degreename1t" class="degree" >${wordetail1.value}</div>
                <div id="company" class="ex-p" >${wordetail2.value}</div>
                <div id="location" class="ex-p" >${wordetail3.value}</div>
            </div>
            </div>
...
if (con1 &&
    ...
    resumeItem.innerHTML = `
         <div class="ex-body">
        <div id="startyear1t" class="yeartow" >${yearstart}</div><div id="endyear1t"  class="yeartow" >${yearend}</div><hr class="year-hr2">
        <div  class="year-bodytow"><div id="degreename1t" class="degree" >${position}</div>
        <div id="company" class="ex-p" >${companyname}</div>
        <div id="location" class="ex-p" >${locationname}</div>
    </div>
    </div>
